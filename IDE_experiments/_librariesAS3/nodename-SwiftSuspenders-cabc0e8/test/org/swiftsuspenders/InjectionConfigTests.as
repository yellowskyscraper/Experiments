package org.swiftsuspenders
{
	...
	import org.swiftsuspenders.injectionresults.InjectFactoryResult;
	...
	public class InjectionConfigTests
	{
		...
		[Test]
		public function injectionTypeFactoryReturnsRespone():void
		{
			var factory : Function = function():Clazz { return new Clazz(); };
			var config : InjectionConfig = new InjectionConfig(Clazz, "");
			config.setResult(new InjectFactoryResult(factory));
			var returnedResponse:Object = config.getResponse(injector);
