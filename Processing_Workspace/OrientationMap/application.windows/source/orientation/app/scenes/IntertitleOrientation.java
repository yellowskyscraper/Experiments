...
public class IntertitleOrientation 
{
	PApplet parent;
	...
	public IntertitleOrientation(PApplet p)
	{
		parent = p;
	}
	...
	{	
		...
		String title = "An Orientation";
		String quote = "For it is never only about the thing itself; it is also about the image one obtains of a thing. \n- Anton Stankowski";
		float quoteWid = 550;
		
		float mainTitleX = xpos;
		float mainTitleY = hei/3;
		float mainQuoteX = (BAYMODEL) ? 514 : 604;
