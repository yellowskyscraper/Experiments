...
public class ArchiveQuake
{
	...
	public void setup(String n, float la, float lo)
	{
		...
		float shockwave = mag;
		Motion.setup(parent);
		tweenBackgroundIN = new Tween(255f, 100f, shockwave/3);
		tweenForegroundIN = new Tween(255f, 120f, shockwave/3);
		tweenStrokeShockWaveIN = new Tween(0f, shockwave, shockwave/3);
		tweenAlphaShockWaveIN = new Tween(255f, 0, shockwave/3);
		
		tweenBackgroundDIM = new Tween(100f, 80f, 10f);
		tweenForegroundDIM = new Tween(120f, 100f, 20f);
		
		tweenBackgroundOUT = new Tween(100f, 0f, 10f);
		tweenForegroundOUT = new Tween(150f, 0f, 10f);
	}
