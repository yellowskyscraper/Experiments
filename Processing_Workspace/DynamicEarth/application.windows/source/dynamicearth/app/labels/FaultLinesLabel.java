...
public class FaultLinesLabel 
{
	...
	public void setup()
	{
		//| Tween Test
		Motion.setup(parent);
		tweenBackgroundIN = new Tween(0f, 255f, 20f, 10);
		tweenForegroundIN = new Tween(0f, 255f, 10f, 20f);
		tweenBackgroundOUT = new Tween(255f, 0f, 20f, 10f);
	...
	{	
		...
		//| Labal
		if(MODEL) this.drawLabel(1019 - 65 - 20, 34 + 278, -90);
		else this.drawLabel(27, 1019 - 65, 0);
