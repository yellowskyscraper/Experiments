...
void tweenParallelStarted(TweenParallel _tg) {
  println(_tg + " started");
}

void tweenParallelEnded(TweenParallel _tg) {
  println(_tg + " ended");
}

void tweenParallelResumed(TweenParallel _tg) {
  println(_tg + " resumed");
}

void tweenParallelPaused(TweenParallel _tg) {
  println(_tg + " paused");
}

void tweenParallelRepeated(TweenParallel _tg) {
