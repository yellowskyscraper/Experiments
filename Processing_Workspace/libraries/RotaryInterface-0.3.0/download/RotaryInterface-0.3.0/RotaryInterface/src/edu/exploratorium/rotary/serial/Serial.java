/*
	adaptation of processing.Serial that allows non-PApplet
	instances to listen for serialEvents.
...
package edu.exploratorium.rotary.serial;
...
//									serialEventMethod.invoke(parent, new Object[] { this });
									serialEventMethod.invoke(serialEventContainer, new Object[] { this });
								} catch (Exception e) {
									String msg = "error, disabling serialEvent() for " + port;
									System.err.println(msg);
									e.printStackTrace();
									serialEventMethod = null;
									serialEventContainer = null;
								}
							}
						}
					}
	...
	public void addListener (Object o) {
		// reflection to check whether an object has a call for
		// public void serialEvent(processing.serial.Serial)
		// which would be called each time an event comes in
		try {
			serialEventMethod = o.getClass().getMethod("serialEvent", new Class[] { Serial.class });
			serialEventContainer = o;
		} catch (Exception e) {
			System.err.println("No public method serialEvent() found in class "+ o.getClass().getName() +".");
		}
	}
