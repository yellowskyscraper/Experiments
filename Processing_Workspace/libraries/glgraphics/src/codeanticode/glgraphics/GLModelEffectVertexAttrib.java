 ...
 */
public class GLModelEffectVertexAttrib extends GLSLShaderAttribute
{
    /**
     ...
     * @param type int 
     */	
    public GLModelEffectVertexAttrib(PApplet parent, String name, String label, int type) 
    {
     ...
     * @param type int 
     */	
    public GLModelEffectVertexAttrib(PApplet parent, GLSLShader shader, String name, String label, int type) 
    {
