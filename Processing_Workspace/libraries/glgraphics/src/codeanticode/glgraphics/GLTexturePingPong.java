...
/**
 This class encapsulates two GLTextures, that are labeled as read and write. The role of each texture is swaped
 upon calling the swap function. This class is intended to simplify the code in GP-GPU applications, where
 there is the need to apply iterative operations on textures holding float data that represents coordinates
 or velocities of particles, etc. This technique of alternatively swaping the textures to allow for read/write
 operations is called "Ping-Pong".
 */
