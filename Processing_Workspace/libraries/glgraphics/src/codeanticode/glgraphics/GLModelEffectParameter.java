...
{
    /**
     * Creates an instance of GLModelEffectParameter using the specified parameters. The shader is set to null.
     * @param parent PApplet
     * @param name String
     * @param label String 
     * @param type int 
     */	
    public GLModelEffectParameter(PApplet parent, String name, String label, int type) 
    {
     ...
     * @param type int 
     */	
    public GLModelEffectParameter(PApplet parent, GLSLShader shader, String name, String label, int type) 
    {
