...
public class GLModel implements PConstants, GLConstants 
{
    ...
    /**
     * Sets the number of attributes for this model. An attribute is a vector value associated to each
     * vertex of the model, and can be used for any custom calculation (lighting, deformations, etc).
     * This custom calculations can be performed using a GLModelEffect.
     * @param n int  
     */	
	public void initAttributes(int n)
	{
	     ...
	     gl.glGenBuffersARB(n, attribVBO, 0);		
	}
	...
	public void setAttribute(int i, String aname, int asize)
	{
        ...
        gl.glBufferDataARB(GL.GL_ARRAY_BUFFER_ARB, size * asize * BufferUtil.SIZEOF_FLOAT, null, vboUsage);
        gl.glBindBufferARB(GL.GL_ARRAY_BUFFER_ARB, 0);
	}
   ...
   /**
	...
	public void beginUpdateAttributes(int n)
	{
		...
		attributes = gl.glMapBufferARB(GL.GL_ARRAY_BUFFER_ARB, GL.GL_WRITE_ONLY).asFloatBuffer();
