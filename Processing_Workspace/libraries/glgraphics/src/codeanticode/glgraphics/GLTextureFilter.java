...
//            else if (blendMode == BURN)
    ...
    {   
        ...
        for (int i = 0; i < n; i++) 
        {
            ...
            else if (name.equals("textures"))
            {
                ...
                srcTexName = new String[numInputTex];
                srcTexOffsetUniformName = new String[numInputTex];
                for (int k = 0; k < numInputTex; k++)
                {
                	srcTexName[k] =  "src_tex_unit" + k;
                    srcTexOffsetUniformName[k] = "src_tex_offset" + k;
                }
    ...
    protected void loadInputTextures(XMLElement xml)
    {
        ...
        {         
            ...
            if (name.equals("intexture"))
            {
            	...
            	{
            		srcTexName[texUnit] = texName;
            	    if (offsetName != null) srcTexOffsetUniformName[texUnit] = offsetName; 
            	}
            	else System.err.println("Wrong texture unit!");
            }
        }        
    }
    ...
    protected void loadSpecialParameters(XMLElement xml)
    {
        ...
        {         
            ...
            if (name.equals("specialpar"))
            {
                ...
                if (parType.equals("clock")) clockDataUniformName = uniformName;
                else if (parType.equals("tint")) destColorUniformName = uniformName;            
                else if (parType.equals("size")) destTexSizeUniformName = uniformName;
            }
        }
    }
    ...
    protected void loadParameters(XMLElement xml)
    {
        ...
        for (int i = 0; i < n; i++)
        {
            child = xml.getChild(i);
            name = child.getName();            
        	if (name.equals("parameter")) addParameter(child);	
        }
    }
    ...
    {  
        ...
        {
	        srcTexUnitUniform[i] = shader.getUniformLocation(srcTexName[i]);
