...
/**
 * This class stores the variable of a GLSL shader (attribute or uniform). It can be of 
 * type int, float, vec2, vec3, vec4, mat2, mat3 or mat4.
 */
abstract class GLSLShaderVariable implements GLConstants
{
    /**
    ...
    /**
     * Creates an instance of GLShaderVariable using the specified parameters. The shader is set to null.
     * @param parent PApplet
     * @param name String
     * @param label String 
     * @param type int 
     */	
    public GLSLShaderVariable(PApplet parent, String name, String label, int type) 
    {
     ...
     * @param type int 
     */	
    public GLSLShaderVariable(PApplet parent, GLSLShader shader, String name, String label, int type) 
    {
    ...
    public void setValue(int value) 
    {
        ...
        else System.err.println("Error in shader variable " + name + ": Wrong type.");
    }
