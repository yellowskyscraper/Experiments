...
public class MapBean extends JComponent implements ComponentListener,
     ...
     * @deprecated Projection Type integers are no longer really used. The
     *             ProjectionFactory should be consulted for which type are
    ...
    /**
     * Set the type of the projection. If different from the current type, this
     * installs a new projection with the same center, scale, width, and height
     * of the previous one.
     * 
